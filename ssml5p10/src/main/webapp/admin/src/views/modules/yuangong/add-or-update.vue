<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="电子邮件" prop="dianziyoujian">
          <el-input v-model="ruleForm.dianziyoujian" 
              placeholder="电子邮件" clearable  :readonly="ro.dianziyoujian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="电子邮件" prop="dianziyoujian">
              <el-input v-model="ruleForm.dianziyoujian" 
                placeholder="电子邮件" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiatingzhuzhi = true;
          ...
          if(o=='dianziyoujian'){
            this.ruleForm.dianziyoujian = obj[o];
	    this.ro.dianziyoujian = true;
            continue;
          }
        }
      }
