<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="床位" prop="chuangwei">
          <el-select v-model="ruleForm.chuangwei" placeholder="请选择床位">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="老人编号" prop="laorenbianhao">
          <el-select  @change="laorenbianhaoChange" v-model="ruleForm.laorenbianhao" placeholder="请选择老人编号">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.laorenbianhao" label="老人编号" prop="laorenbianhao">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="房间信息" prop="fangjianxinxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="房间信息"
                  v-model="ruleForm.fangjianxinxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangjianxinxi" label="房间信息" prop="fangjianxinxi">
                    <span>{{ruleForm.fangjianxinxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhusufei = true;
          ...
          if(o=='fangjianxinxi'){
            this.ruleForm.fangjianxinxi = obj[o];
	    this.ro.fangjianxinxi = true;
            continue;
          }
          if(o=='laorenbianhao'){
        ...
        this.ruleForm.chuangwei = 0
	this.ro.chuangwei = false;
      }
      // 获取用户信息
      this.$http({
    ...
    onSubmit() {
      ...
      if(obj!=null) {
	      obj.chuangwei = obj.chuangwei - this.ruleForm.chuangwei
	      if(obj.chuangwei<0){
		this.$message.error("床位不足");
		return
	      }
	      this.$http({
		  url: `${table}/update`,
